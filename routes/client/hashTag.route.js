...
route.get("/retrievePopularHashtag", checkAccessWithSecretKey(), HashTagController.retrievePopularHashtag);

//get particular hashTag's video ( web )
route.get("/trendingHashTagVideos", checkAccessWithSecretKey(), HashTagController.trendingHashTagVideos);
