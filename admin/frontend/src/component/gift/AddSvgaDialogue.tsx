...
const AddSvgaDialogue = () => {
  ...
  const canCreate = can("Gift", "Create");
  const canEdit = can("Gift", "Edit");
      ...
      >
        <Box sx={style} className="">
          ...
          <div className="model-header">
            <p className="m-0">{dialogueData ? "Edit Gift" : "Add Gift"}</p>
          </div>
          <div className="model-body">
            <form>
              <div className="row sound-add-box gift-dialogue-row">
                ...
                <div className="col-12 mt-2">
                  <Input
                    ...
                    errorMessage={
                      !dialogueData ? error.image && error.image : ""
                    }
                    onChange={handleInputImage}
                  />
                  <p className="gift-dialogue-note">
                    (Note: Accept only .svga, .gif, .webp)
                  </p>
                </div>
                    ...
                    {imagePath && (
                      <>
                        {!isSvga ? (
                          ...
                          <>
                            <div id="svga" className="gift-dialogue-svga"></div>
                          </>
                        )}
                      </>
                    )}
          ...
          <div className="model-footer">
            <div className="p-3 d-flex justify-content-end gift-dialogue-footer">
              <Button
              ...
              {(mongoId ? canEdit : canCreate) && (
                <Button
                  ...
                  newClass={"submit-btn gift-dialogue-submit-btn"}
                />
              )}
            </div>
          </div>
