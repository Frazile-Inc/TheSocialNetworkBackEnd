...
import { appSetting, coinSetting, fakeDataSetting, firebaseNotificationSetting, loginBonusSetting, mediaModerationSetting, resendApiSetting, shortsEffectSetting, waterMarkSetting, zegoSetting } from "@/extra/infoContent";
                  ...
                  <div className="row w-100">
                    ...
                    <div style={{ display: "flex", rowGap: "10px" }}>
                      <div className="w-100 custom-border">
                        <div className="w-100 custom-border">
                          <Multiselect
                            placeholder={"Nudity and Adult Content"}
              ...
              <div className="mb-4">
                ...
                <div className="withdrawal-box payment-box  mt-4">
                  <h6 className="d-flex justify-content-between align-items-center">
                    Login Bonus Setting
                    <InfoTooltip
                      title="Login Bonus Setting"
                      content={loginBonusSetting}
                    />
                  </h6>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 withdrawal-input">
                        <Input
                          ...
                          type={"text"}
                          placeholder={"VYE6auoX0pkEjGcyNuOhJyG0bd4B0Y"}
                          onChange={(e) => {
